...
#End Region
    ...
    Private Sub frmCanvas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        activeImgIdx = Get_LOimg_ID("Flash")
        Dim b = ";;;;;;" & LOImg(activeImgIdx).SpeedLR & "; Size: " & Size.ToString & Environment.NewLine _
        & "Counter" & ";" _
        & "Name-ID ;" _
        & "Left ;" _
    ...
    Private Sub Create_New()
        ...
        For i = 0 To CountTO
            ...
            Select Case i
                Case 0
                    SR = 1
                    FN = MainImageDir & "\Foreground\Base.png"
                    Top = -8
                    Nme = "Base"
                    Cat = "Background"
                    'seqMoveLR = EAST
...
#End Region
    ...
    Private Sub frmCanvas_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.SizeChanged
        Text = Size.ToString
